...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 09 Oca 2021, 19:20:26
...
(0, 'dimg/257352170130202280452666029586slide-4.jpg', 'https://translate.google.com/?hl=tr', 'Makale Bloğum', 'Bu sayfada makale ve haberlerinizi paylaşabilirsiniz', 'makale, haber, sosyal ağ', '24 Lab', '0545 230 18 49', '0545 230 18 49', '0545 230 18 491', 'alitunacanonar@icloud.com', 'Erbaa', 'İstanbul', 'Yeşilyurt Mahalllesi', '7 x 24 açık', '2b', '1a', '3c', 'www.facebook.com', 'www.twitter.com', 'www.google.com', 'www.youtube.com', 'aaa@gmail.comcc', 'Ali Tunacan', 'password', '25', '');
...
CREATE TABLE `kategori` (
  ...
  `kategori_durum` enum('1','0') COLLATE utf8_turkish_ci NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
(2, 'Çanta', 0, 'canta', 1, '1'),
(3, 'Ayakkabı', 4, 'ayakkabi', 2, '1'),
(4, 'Giyim', 0, 'giyim', 3, '1'),
(5, 'Parfüm', 0, 'parfum', 4, '1'),
(6, 'Template', 0, 'template', 5, '1'),
(7, 'Elektronik', 0, 'elektronik', 11, '1'),
(8, 'Gıda', 0, 'gida', 9, '1');
...
CREATE TABLE `kullanici` (
  ...
  `kullanici_gsm` varchar(20) COLLATE utf8_turkish_ci NOT NULL,
...
(1, '2020-12-06 17:06:13', '', '55684529770', 'Can', 'can@gmail.com', '5253652859', 'e10adc3949ba59abbe56e057f20f883e', 'Can Türkoğlud', 'Yeşilyurt Mah. Eski hamam', 'Tokat', 'Erbaa', '', '5', 0),
(5, '2020-12-14 00:29:54', '', '', '', 'ali@icloud.com', '', 'e10adc3949ba59abbe56e057f20f883e', 'Ali', '', 'Tekirdağ', 'Çorlu', '', '1', 1),
(6, '2020-12-23 22:21:33', '', '', '', 'karadeniz@hotmail.com', '', 'e10adc3949ba59abbe56e057f20f883e', 'Ali Karadeniz', '', 'İstanbul', 'Fatih', '', '1', 1);
...
(3, 'Slider 1', 'dimg/slider/3046030641285202142031000284342269420298slide-1.jpg', 1, '', '1'),
(4, 'Slider 2', 'dimg/slider/211642649921354282172963631605299042912322940slide-2.jpg', 2, '', '1'),
(5, 'Slider 3', 'dimg/slider/21283277752655520099slide-3.jpg', 3, '', '1');
...
CREATE TABLE `urun` (
  ...
  `urun_durum` enum('1','0') COLLATE utf8_turkish_ci NOT NULL,
  `urun_onecikar` enum('1','0') COLLATE utf8_turkish_ci NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
(0, 4, '2020-12-24 20:05:03', 'Louis Marie Güpürlü Kadife 4lu Kutulu Havlu 50 X 90 13001', 'louis-marie-gupurlu-kadife-4lu-kutulu-havlu-50-x-90-13001', '<p>&Uuml;r&uuml;n Bilgileri</p>\r\n\r\n<p>T&uuml;m &Ouml;zellikleri G&ouml;r</p>\r\n\r\n<p>15 g&uuml;n i&ccedil;inde &uuml;cretsiz iade.Detaylı bilgi i&ccedil;in&nbsp;tıklayın</p>\r\n\r\n<p>Bu &uuml;r&uuml;n&nbsp;Louis Marie&nbsp;tarafından g&ouml;nderilecektir.</p>\r\n\r\n<p>&Uuml;r&uuml;n&uuml;n i&ccedil;erisinde 4 adet havlu bulunmaktadır. %100 pamuk ipliğinden &uuml;retilmiştir. &uuml;r&uuml;nlerimiz 1. Kalite, &uuml;reticiden direk t&uuml;keticiye satışımızdır. &uuml;r&uuml;nlerimize yıkama ve sıvı &ccedil;ekme testleri uygulanmıştır. iyi g&uuml;nlerde kullanmanızı dileriz.</p>\r\n\r\n<p>Bu &uuml;r&uuml;nden en fazla 10 adet sipariş verilebilir. 10 adetin &uuml;zerindeki siparişleri Trendyol iptal etme hakkını saklı tutar.</p>\r\n\r\n<p>Kampanya fiyatından satılmak &uuml;zere 100 adetten fazla stok sunulmuştur.</p>\r\n\r\n<p>İncelemiş olduğunuz &uuml;r&uuml;n&uuml;n satış fiyatını satıcı belirlemektedir.</p>\r\n', 40, '', 'güpürlü, özdilek', 200, '1', '1'),
(2, 3, '2020-12-16 21:23:05', 'Ülker Çikolata Fıstıklı', 'ulker-cikolata-fistikli', '<p>&Uuml;lker &Ccedil;ikolata Fıstıklı Kare 70 G &Uuml;lker Antep Fıstıklı Kare &Ccedil;ikolata, yumuşacık, ağızda eriyen yapısı ve taze, b&uuml;t&uuml;n antep fıstıkları ile olduk&ccedil;a lezzetli bir &ccedil;ikolatadır. 1974 yılında &ccedil;ikolata &uuml;retimine başlayan &Uuml;lker, bu tarihten itibaren &Uuml;lker &Ccedil;ikolata adı altında T&uuml;rk damak zevkine uygun &ccedil;ikolatalarını t&uuml;keticiyle buluşturmayı s&uuml;rd&uuml;rmektedir. &Uuml;lker Antep Fıstıklı Kare &Ccedil;ikolata da bunun en g&uuml;zel &ouml;rneklerinden biridir. İşletme Kayıt No TR-34-K-011995 Net Miktar (g/ml) 70 Menşei T&Uuml;RKİYE İ&ccedil;indekiler Şeker, tam yağlı s&uuml;ttozu, antep fıstığı %18, kakao yağı, kakao kitlesi, em&uuml;lgat&ouml;r (soya lesitini), tuz, aroma verici. Kakao kuru maddesi en az %29?dur. Eser miktarda yerfıstığı, sert kabuklu meyveler, yumurta &uuml;r&uuml;n&uuml; ve gluten i&ccedil;erebilir. Domuz yağı ve katkıları i&ccedil;ermez. Alerjen Uyarısı Eser miktarda yer fıstığı ,sert kabuklu meyveler ,yumurta &uuml;r&uuml;n&uuml; ,ve gluten i&ccedil;erebilir. S&uuml;t ve soya i&ccedil;ermektedir. Saklama Koşulları Serin ve Kuru ortamda muhafaza ediniz Gıda İşletmecisi / &Uuml;retici / İthalat&ccedil;ı / Dağıtıcı PASİFİK T&Uuml;KETİM &Uuml;R&Uuml;NLERİ SATIŞ VE TİC.A.Ş. &Uuml;r&uuml;n Bilgilerini Kullanma Hakkında İnternet sitemizde ve online satış kanallarımızda yer alan &uuml;r&uuml;n etiket bilgileri, &uuml;r&uuml;n&uuml;n tedarik&ccedil;isi tarafından Migros Ticaret A.Ş.&rsquo;ye iletilen en g&uuml;ncel bilgilerdir. &Uuml;r&uuml;n etiket bilgileri ile internet sitemiz ve online satış kanallarımızda bulunan bilgiler arasında herhangi bir farklılık bulunması halinde sorumluluk tamamen tedarik&ccedil;i firmaya aittir.</p>\r\n', 7.75, 'nDZO5m2ExBE', 'çikolata, ülker, antep fıstıklı, sütlü', 100, '1', '1'),
(3, 6, '2020-12-20 18:56:10', 'Agency', 'agency', '<p>Description</p>\r\n\r\n<p>Agency is a one page HTML/CSS theme built with Bootstrap. This theme is perfect for agencies or small businesses looking to set up a simple landing page for their company. The theme can also be modified and adjusted to fit just about any purpose! Download this free Bootstrap theme now to get started!</p>\r\n\r\n<p>Features</p>\r\n\r\n<p>Responsive top navigation that collapses and restyled when the page is scrolled</p>\r\n\r\n<p>Smooth scrolling navigation to optimize the one page website user experience</p>\r\n\r\n<p>Integration with Font Awesome Icons</p>\r\n\r\n<p>Portfolio grid with modal windows for each item to showcase more detailed content for each portfolio item</p>\r\n\r\n<p>About section with a responsive timeline</p>\r\n\r\n<p>Team member section with profile images and social media links</p>\r\n\r\n<p>Working PHP contact form complete with validation and form actions - just add your email address to the included PHP file and it&#39;s ready to host!</p>\r\n\r\n<p>Footer with social links, copyright information, and additional page links</p>\r\n\r\n<p>SCSS and Pug files included in the source files on GitHub for deeper customization and development</p>\r\n', 20, '', 'free, bootstrap, agency, one page', 100, '1', '1'),
(10, 5, '2020-12-24 19:59:43', 'Aqua Di Polo', 'aqua-di-polo', '<p>&Uuml;r&uuml;n Bilgileri</p>\r\n\r\n<p>T&uuml;m &Ouml;zellikleri G&ouml;r</p>\r\n\r\n<p>15 g&uuml;n i&ccedil;inde &uuml;cretsiz iade.Detaylı bilgi i&ccedil;in&nbsp;tıklayın</p>\r\n\r\n<p>Bu &uuml;r&uuml;n&nbsp;GSS Commerce&nbsp;tarafından g&ouml;nderilecektir.</p>\r\n\r\n<p>İtalyan Alplerinin efsanevi zirvesi. Tutkulu, unutulmaz, iz bırakan, sınır tanımayan bir erkek. Kadınların g&uuml;&ccedil;l&uuml; sevgilisi, hayran oldukları şampiyon. Gran Paradiso, tutkulu erkeklerin kokusu! Taze bir g&uuml;n i&ccedil;in okyanus ve greyfurt notaları ile başlayan Gran Paradiso, orta notalarında odunsu tonlardaki defne ve yasemin notaları ile şehvetli karakterini &ouml;ne &ccedil;ıkarıyor. Tutkulu yapısını ortaya koyan g&uuml;&ccedil;l&uuml; alt notaları ise amber, meşe yosunu, laden ve guaiac ağacından oluşmaktadır. Duş sonrası doğrudan temiz cilde veya 15-20 cm uzaklıktan kıyafetinize spreyleyerek kullanabilirsiniz. Yoğun aroma esansı ile g&uuml;n boyu kendisini hissettirecektir. %100 orijinaldir. Ambalajı a&ccedil;ılan &uuml;r&uuml;nlerin iadesi kabul edilmemektedir.</p>\r\n\r\n<p>Bu &uuml;r&uuml;nden en fazla 10 adet sipariş verilebilir. 10 adetin &uuml;zerindeki siparişleri Trendyol iptal etme hakkını saklı tutar.</p>\r\n\r\n<p>Kampanya fiyatından satılmak &uuml;zere 100 adetten fazla stok sunulmuştur.</p>\r\n\r\n<p>İncelemiş olduğunuz &uuml;r&uuml;n&uuml;n satış fiyatını satıcı belirlemektedir.</p>\r\n', 30, '', 'parfüm, elite, fransız', 20, '1', '1'),
(11, 2, '2020-12-24 20:03:26', 'Haylou', 'haylou', '<p>&Uuml;r&uuml;n Bilgileri</p>\r\n\r\n<p>T&uuml;m &Ouml;zellikleri G&ouml;r</p>\r\n\r\n<p>15 g&uuml;n i&ccedil;inde &uuml;cretsiz iade.Detaylı bilgi i&ccedil;in&nbsp;tıklayın</p>\r\n\r\n<p>&Uuml;r&uuml;n beden tablosunu g&ouml;r&uuml;nt&uuml;lemek i&ccedil;in&nbsp;tıklayın</p>\r\n\r\n<p>Bu &uuml;r&uuml;n&nbsp;OrkaTeknoloji&nbsp;tarafından g&ouml;nderilecektir.</p>\r\n\r\n<p>İ&ccedil; materyal: Tekstil Dış materyal: Tekstil Taban: Poli&uuml;retan Kalıp: Standart</p>\r\n\r\n<p>Bu &uuml;r&uuml;nden en fazla 10 adet sipariş verilebilir. 10 adetin &uuml;zerindeki siparişleri Trendyol iptal etme hakkını saklı tutar.</p>\r\n\r\n<p>Kampanya fiyatından satılmak &uuml;zere 100 adetten fazla stok sunulmuştur.</p>\r\n\r\n<p>İncelemiş olduğunuz &uuml;r&uuml;n&uuml;n satış fiyatını satıcı belirlemektedir.</p>\r\n', 194, '', 'solar, ls05, smart watch', 18, '1', '1'),
(13, 4, '2020-12-24 20:05:03', 'Louis Marie Güpürlü Kadife 4lu Kutulu Havlu 50 X 90 13001', 'louis-marie-gupurlu-kadife-4lu-kutulu-havlu-50-x-90-13001', '<p>&Uuml;r&uuml;n Bilgileri</p>\r\n\r\n<p>T&uuml;m &Ouml;zellikleri G&ouml;r</p>\r\n\r\n<p>15 g&uuml;n i&ccedil;inde &uuml;cretsiz iade.Detaylı bilgi i&ccedil;in&nbsp;tıklayın</p>\r\n\r\n<p>Bu &uuml;r&uuml;n&nbsp;Louis Marie&nbsp;tarafından g&ouml;nderilecektir.</p>\r\n\r\n<p>&Uuml;r&uuml;n&uuml;n i&ccedil;erisinde 4 adet havlu bulunmaktadır. %100 pamuk ipliğinden &uuml;retilmiştir. &uuml;r&uuml;nlerimiz 1. Kalite, &uuml;reticiden direk t&uuml;keticiye satışımızdır. &uuml;r&uuml;nlerimize yıkama ve sıvı &ccedil;ekme testleri uygulanmıştır. iyi g&uuml;nlerde kullanmanızı dileriz.</p>\r\n\r\n<p>Bu &uuml;r&uuml;nden en fazla 10 adet sipariş verilebilir. 10 adetin &uuml;zerindeki siparişleri Trendyol iptal etme hakkını saklı tutar.</p>\r\n\r\n<p>Kampanya fiyatından satılmak &uuml;zere 100 adetten fazla stok sunulmuştur.</p>\r\n\r\n<p>İncelemiş olduğunuz &uuml;r&uuml;n&uuml;n satış fiyatını satıcı belirlemektedir.</p>\r\n', 40, '', 'güpürlü, özdilek', 200, '1', '1'),
(14, 3, '2020-12-16 21:23:05', 'Ülker Çikolata Fıstıklı', 'ulker-cikolata-fistikli', '<p>&Uuml;lker &Ccedil;ikolata Fıstıklı Kare 70 G &Uuml;lker Antep Fıstıklı Kare &Ccedil;ikolata, yumuşacık, ağızda eriyen yapısı ve taze, b&uuml;t&uuml;n antep fıstıkları ile olduk&ccedil;a lezzetli bir &ccedil;ikolatadır. 1974 yılında &ccedil;ikolata &uuml;retimine başlayan &Uuml;lker, bu tarihten itibaren &Uuml;lker &Ccedil;ikolata adı altında T&uuml;rk damak zevkine uygun &ccedil;ikolatalarını t&uuml;keticiyle buluşturmayı s&uuml;rd&uuml;rmektedir. &Uuml;lker Antep Fıstıklı Kare &Ccedil;ikolata da bunun en g&uuml;zel &ouml;rneklerinden biridir. İşletme Kayıt No TR-34-K-011995 Net Miktar (g/ml) 70 Menşei T&Uuml;RKİYE İ&ccedil;indekiler Şeker, tam yağlı s&uuml;ttozu, antep fıstığı %18, kakao yağı, kakao kitlesi, em&uuml;lgat&ouml;r (soya lesitini), tuz, aroma verici. Kakao kuru maddesi en az %29?dur. Eser miktarda yerfıstığı, sert kabuklu meyveler, yumurta &uuml;r&uuml;n&uuml; ve gluten i&ccedil;erebilir. Domuz yağı ve katkıları i&ccedil;ermez. Alerjen Uyarısı Eser miktarda yer fıstığı ,sert kabuklu meyveler ,yumurta &uuml;r&uuml;n&uuml; ,ve gluten i&ccedil;erebilir. S&uuml;t ve soya i&ccedil;ermektedir. Saklama Koşulları Serin ve Kuru ortamda muhafaza ediniz Gıda İşletmecisi / &Uuml;retici / İthalat&ccedil;ı / Dağıtıcı PASİFİK T&Uuml;KETİM &Uuml;R&Uuml;NLERİ SATIŞ VE TİC.A.Ş. &Uuml;r&uuml;n Bilgilerini Kullanma Hakkında İnternet sitemizde ve online satış kanallarımızda yer alan &uuml;r&uuml;n etiket bilgileri, &uuml;r&uuml;n&uuml;n tedarik&ccedil;isi tarafından Migros Ticaret A.Ş.&rsquo;ye iletilen en g&uuml;ncel bilgilerdir. &Uuml;r&uuml;n etiket bilgileri ile internet sitemiz ve online satış kanallarımızda bulunan bilgiler arasında herhangi bir farklılık bulunması halinde sorumluluk tamamen tedarik&ccedil;i firmaya aittir.</p>\r\n', 7.75, 'nDZO5m2ExBE', 'çikolata, ülker, antep fıstıklı, sütlü', 100, '1', '1'),
(15, 6, '2020-12-20 18:56:10', 'Agency', 'agency', '<p>Description</p>\r\n\r\n<p>Agency is a one page HTML/CSS theme built with Bootstrap. This theme is perfect for agencies or small businesses looking to set up a simple landing page for their company. The theme can also be modified and adjusted to fit just about any purpose! Download this free Bootstrap theme now to get started!</p>\r\n\r\n<p>Features</p>\r\n\r\n<p>Responsive top navigation that collapses and restyled when the page is scrolled</p>\r\n\r\n<p>Smooth scrolling navigation to optimize the one page website user experience</p>\r\n\r\n<p>Integration with Font Awesome Icons</p>\r\n\r\n<p>Portfolio grid with modal windows for each item to showcase more detailed content for each portfolio item</p>\r\n\r\n<p>About section with a responsive timeline</p>\r\n\r\n<p>Team member section with profile images and social media links</p>\r\n\r\n<p>Working PHP contact form complete with validation and form actions - just add your email address to the included PHP file and it&#39;s ready to host!</p>\r\n\r\n<p>Footer with social links, copyright information, and additional page links</p>\r\n\r\n<p>SCSS and Pug files included in the source files on GitHub for deeper customization and development</p>\r\n', 20, '', 'free, bootstrap, agency, one page', 100, '1', '1'),
(16, 5, '2020-12-24 19:59:43', 'Aqua Di Polo', 'aqua-di-polo', '<p>&Uuml;r&uuml;n Bilgileri</p>\r\n\r\n<p>T&uuml;m &Ouml;zellikleri G&ouml;r</p>\r\n\r\n<p>15 g&uuml;n i&ccedil;inde &uuml;cretsiz iade.Detaylı bilgi i&ccedil;in&nbsp;tıklayın</p>\r\n\r\n<p>Bu &uuml;r&uuml;n&nbsp;GSS Commerce&nbsp;tarafından g&ouml;nderilecektir.</p>\r\n\r\n<p>İtalyan Alplerinin efsanevi zirvesi. Tutkulu, unutulmaz, iz bırakan, sınır tanımayan bir erkek. Kadınların g&uuml;&ccedil;l&uuml; sevgilisi, hayran oldukları şampiyon. Gran Paradiso, tutkulu erkeklerin kokusu! Taze bir g&uuml;n i&ccedil;in okyanus ve greyfurt notaları ile başlayan Gran Paradiso, orta notalarında odunsu tonlardaki defne ve yasemin notaları ile şehvetli karakterini &ouml;ne &ccedil;ıkarıyor. Tutkulu yapısını ortaya koyan g&uuml;&ccedil;l&uuml; alt notaları ise amber, meşe yosunu, laden ve guaiac ağacından oluşmaktadır. Duş sonrası doğrudan temiz cilde veya 15-20 cm uzaklıktan kıyafetinize spreyleyerek kullanabilirsiniz. Yoğun aroma esansı ile g&uuml;n boyu kendisini hissettirecektir. %100 orijinaldir. Ambalajı a&ccedil;ılan &uuml;r&uuml;nlerin iadesi kabul edilmemektedir.</p>\r\n\r\n<p>Bu &uuml;r&uuml;nden en fazla 10 adet sipariş verilebilir. 10 adetin &uuml;zerindeki siparişleri Trendyol iptal etme hakkını saklı tutar.</p>\r\n\r\n<p>Kampanya fiyatından satılmak &uuml;zere 100 adetten fazla stok sunulmuştur.</p>\r\n\r\n<p>İncelemiş olduğunuz &uuml;r&uuml;n&uuml;n satış fiyatını satıcı belirlemektedir.</p>\r\n', 30, '', 'parfüm, elite, fransız', 20, '1', '1'),
(17, 2, '2020-12-24 20:03:26', 'Haylou', 'haylou', '<p>&Uuml;r&uuml;n Bilgileri</p>\r\n\r\n<p>T&uuml;m &Ouml;zellikleri G&ouml;r</p>\r\n\r\n<p>15 g&uuml;n i&ccedil;inde &uuml;cretsiz iade.Detaylı bilgi i&ccedil;in&nbsp;tıklayın</p>\r\n\r\n<p>&Uuml;r&uuml;n beden tablosunu g&ouml;r&uuml;nt&uuml;lemek i&ccedil;in&nbsp;tıklayın</p>\r\n\r\n<p>Bu &uuml;r&uuml;n&nbsp;OrkaTeknoloji&nbsp;tarafından g&ouml;nderilecektir.</p>\r\n\r\n<p>İ&ccedil; materyal: Tekstil Dış materyal: Tekstil Taban: Poli&uuml;retan Kalıp: Standart</p>\r\n\r\n<p>Bu &uuml;r&uuml;nden en fazla 10 adet sipariş verilebilir. 10 adetin &uuml;zerindeki siparişleri Trendyol iptal etme hakkını saklı tutar.</p>\r\n\r\n<p>Kampanya fiyatından satılmak &uuml;zere 100 adetten fazla stok sunulmuştur.</p>\r\n\r\n<p>İncelemiş olduğunuz &uuml;r&uuml;n&uuml;n satış fiyatını satıcı belirlemektedir.</p>\r\n', 194, '', 'solar, ls05, smart watch', 18, '1', '1');
...
(16, 11, 'dimg/urun/28813216332200325453haylou1.jpg', 0),
(17, 10, 'dimg/urun/22170317912058831148saat1.jpg', 0),
(22, 3, 'dimg/urun/30198298432756320840haylou1.jpg', 0),
(23, 0, 'dimg/urun/21409210442079920206haylou1.jpg', 0),
(24, 2, 'dimg/urun/20927268552338830143saat1.jpg', 0),
(25, 17, 'dimg/urun/24344255942324622220saat1.jpg', 0),
(26, 16, 'dimg/urun/2907430195269352569328813216332200325453haylou1.jpg', 0),
(27, 15, 'dimg/urun/28012291102359130552saat1.jpg', 0),
(28, 14, 'dimg/urun/26113305952238426143saat1.jpg', 0),
(29, 13, 'dimg/urun/2926424661307233022228813216332200325453haylou1.jpg', 0);
...
CREATE TABLE `yorumlar` (
  ...
  `urun_id` int(11) NOT NULL,
  `yorum_onay` enum('1','0') COLLATE utf8_turkish_ci NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
(25, 5, 'yorum yapıldı', '2020-12-26 19:05:43', 11, '1'),
(26, 5, 'cxzcxz', '2020-12-26 19:10:54', 0, '1'),
(31, 6, 'sdfghjkl', '2020-12-26 19:45:07', 11, '1'),
(32, 6, 'güzel ürün', '2020-12-27 13:28:12', 3, '1'),
(33, 5, 'Yorum x', '2020-12-30 12:21:42', 11, '1'),
(34, 5, 'yorum y', '2020-12-30 12:31:36', 11, '1'),
(35, 5, 'yorum z', '2020-12-30 12:31:45', 11, '1');
...
--
ALTER TABLE `urunfoto`
  MODIFY `urunfoto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
