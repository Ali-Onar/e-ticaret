					...
					<div class="col-md-8">
						<div class="pushright">
							<div class="top">
								...
								<?php } else { ?>
									<a href="#" class="btn btn-default btn-dark">Hoşgeldiniz<span><?php echo $kullanicicek['kullanici_adsoyad']; ?></span></a>
								<?php } ?>
										...
										<div class="col-md-6 regform">
											...
											<form action="nedmin/netting/islem.php" method="POST" role="form">
												<div class="form-group">
													<input type="text" class="form-control" name="kullanici_mail" id="username" placeholder="Kullanıcı Adı (Mail Adresiniz!)">
												</div>
												<div class="form-group">
