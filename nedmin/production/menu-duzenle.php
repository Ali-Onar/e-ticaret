            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="kullanici_zaman" disabled="" value="<?php echo $_SERVER['HTTP_HOST']."/".$_SERVER['REQUEST_URI'] ?>sayfa-<?php echo seo($menucek['menu_ad']) ?>" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
